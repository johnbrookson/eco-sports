...
// - `dark`: usada em /atletas. Sticky, fundo escuro (#0b0f1a) alinhado com
//   a estética editorial da vitrine e dos perfis /atleta/[slug].
//
...
const variants: Record<SiteNavVariant, VariantTokens> = {
  ...
  dark: {
    nav: "sticky top-0 z-20 bg-[#0b0f1a]/90 backdrop-blur-lg border-b border-white/10",
    logo: "text-white",
    linkBase: "text-white/70 hover:text-white transition-colors",
    linkActive: "text-white font-semibold",
    signInBtn: "text-white/90 hover:text-white hover:bg-white/10",
    signUpBtn: "bg-white text-[#0b0f1a] hover:bg-white/90",
    mobile: "hero",
  },
};
